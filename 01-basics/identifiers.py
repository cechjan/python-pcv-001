...
x = 0
# global = 1    -   proměnná rezervovaná pro python
var_global = 1
PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá'    -   použití neplatného symbolu
hilda_sspu_opava_cz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
#007agent = 'James Bond'    -   proměnná nesmí začínat číslem (numerickým znakem)
agent007 = 'James Bond'
